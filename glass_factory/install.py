...
def create_glass_custom_fields():
	...
	quotation_item_glass_fields = [
		...
		{"fieldname": "gf_raw_sheet_item", "label": "Raw Sheet Item", "fieldtype": "Link", "options": "Item", "insert_after": "gf_glass_specification", **hidden_glass_meta},
		...
		{"fieldname": "gf_source_row_id", "label": "Source Row ID", "fieldtype": "Data", "insert_after": "gf_area_m2", **hidden_glass_meta},
	]
	common_selling_fields = [
		...
		{"fieldname": "gf_raw_sheet_item", "label": "Raw Sheet Item", "fieldtype": "Link", "options": "Item", "insert_after": "gf_glass_specification", "read_only": 1},
		...
		{"fieldname": "gf_source_row_id", "label": "Source Row ID", "fieldtype": "Data", "read_only": 1, "insert_after": "gf_area_m2"},
	]
	...
	custom_fields = {
		...
		"Delivery Note Item": [
			...
			{"fieldname": "gf_cutting_job", "label": "Cutting Job", "fieldtype": "Link", "options": "Cutting Job", "read_only": 1, "insert_after": "gf_glass_specification"},
			{"fieldname": "gf_processing_job", "label": "Glass Processing Job", "fieldtype": "Link", "options": "Glass Processing Job", "read_only": 1, "insert_after": "gf_cutting_job"},
		],
		"Stock Entry": [
